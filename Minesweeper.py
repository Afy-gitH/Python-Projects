# using recursion and clases to build command line minesweeper
#lets create a board object to represend the minesweeper game
#so that we can say "create a new board object" or "dig here", or "render this game fr this object"
import random
import re
